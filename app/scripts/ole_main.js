 ...
 const POSTERS_PER_REEL = 12;
 const REEL_RADIUS = 200;

var setup_posters = function (reel) {
 ...
 function init ()
 {
   setup_posters(document.getElementById('reel-1'));
   setup_posters(document.getElementById('reel-2'));
   setup_posters(document.getElementById('reel-3'));
 }
